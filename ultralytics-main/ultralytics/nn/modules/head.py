...
__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder","GREHead"
...
class RepConv(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.att(self.act(self.conv1(x) + self.conv2(x) + id_out))
...
class GREHead(nn.Module):
    ...
    def __init__(self, nc=80, ch=()):  # detection layer
        ...
        self.stem = nn.ModuleList(nn.Sequential(RepConv(x, x, 3,g=x)) for x in ch) # two 3x3 Group Conv
